  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="bg-surface border border-border rounded-xl p-8">
        <h2 className="font-serif text-xl text-text-primary mb-1">Create your account</h2>
        <p className="text-text-muted text-sm mb-6">Start your Python to ML journey today</p>
