...
const variantClasses = {
  primary: 'bg-primary hover:bg-primary-hover text-background font-semibold',
  secondary: 'bg-surface-light hover:bg-border text-text-primary border border-border',
